        ...
        <div className="h-[40rem] w-full flex flex-col items-center justify-center overflow-hidden rounded-md">
          ...
          <div className="flex flex-col items-center justify-center mt-12">
            <WavyBackground className="max-w-4xl mx-auto px-8">
              <p className="text-lg md:text-xl text-white/80 text-center font-light leading-relaxed">
                A passionate software developer dedicated to crafting elegant solutions 
                and building innovative web experiences. Specialized in modern web technologies 
